...
public class Janela1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtVertice.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N

        txtResposta.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N

        jLabel10.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel10.setText("Entre com o numero do vértice");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(txtVertice, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtResposta, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel11))))
    ...
    private void btnInserirArestaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirArestaActionPerformed
        grafo.addAresta(Integer.parseInt(this.cmbOrigem.getSelectedItem().toString()) ,
                Integer.parseInt(this.cmbDestino.getSelectedItem().toString()),
                Integer.parseInt(this.txtPeso.getText()));
   
        this.txtarGrafo.setText(grafo.toString());
    ...
    private void txtMenorCaminhoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMenorCaminhoActionPerformed
        // Calculate Dijkstra.
        grafo.calcular(grafo.getVertice(Integer.parseInt(this.txtVerticeInicial.getText())));
        
        this.txtarDijkstra.setText(grafo.gerarStringDijkstra());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        grafo.addAresta(2, 1, 8);
        grafo.addAresta(2, 8, 2);
        grafo.addAresta(2, 5, 4);
        grafo.addAresta(2, 3, 7);
        grafo.addAresta(3, 2, 7);
        grafo.addAresta(3, 5, 14);
        grafo.addAresta(3, 4, 9);
        grafo.addAresta(4, 3, 9);
        grafo.addAresta(4, 5, 10);
        grafo.addAresta(5, 4, 10);
        grafo.addAresta(5, 3, 9);
        grafo.addAresta(5, 2, 4);
        grafo.addAresta(5, 6, 2);
        grafo.addAresta(6, 7, 1);
        grafo.addAresta(6, 8, 6);
        grafo.addAresta(6, 5, 2);
        grafo.addAresta(7, 0, 8);
        grafo.addAresta(7, 8, 7);
        grafo.addAresta(7, 1, 11);
        grafo.addAresta(7, 6, 1);
        grafo.addAresta(8, 2, 2);
        grafo.addAresta(8, 7, 7);
        grafo.addAresta(8, 6, 6);
        
        this.txtarGrafo.setText(grafo.toString());
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Vertice vertice = this.grafo.getVertice(Integer.parseInt(txtVertice.getText()));
        int t = grafo.getVertices().size();
        double soma = 0;
        
        for(int i = 0; i < t; i++){
            Vertice aux = grafo.getVertice(i);
            int t2 = aux.adjacentes.size();
            for(int j = 0; j < t2; j++){
                if(aux.adjacentes.get(j).fim == vertice){
                    soma = soma + aux.adjacentes.get(j).peso;
                }
            }
        }
        txtResposta.setText(String.valueOf(soma));
